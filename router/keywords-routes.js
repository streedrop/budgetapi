...
router.post('/', (req, res) => {
  ...
  db.query('INSERT INTO keywords (source, match_type, keyword, action, category_id, new_string) VALUES (?, ?, ?, ?, ?, ?)', [source, match_type, keyword, action, category_id, new_string], (err, results) => {
